...
/**
 * append_hexa_code - Adds the hexadecimal representation of an
 * ASCII code to the buffer
 * @buffer: Array of characters used for appending
 ...
 * @size: Size specifier indicating the type to be converted to.
 *
